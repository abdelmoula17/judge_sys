 ...
 -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row">
            <div class = "col-sm">
            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" onchange="change_code_screen(this.value)">
             <option selected>choose language</option>
             <?php
                  $field = isset($_GET["field"]) ? $_GET["field"] : "";
                  $query = "SELECT * FROM lang_field INNER JOIN languages ON  lang_field.field_id = $field && lang_field.lang_id = languages.lang_id";
          ...
          ?>
            ...
            <div class= "card">
              <textarea id= "editor" aria-label="With textarea"></textarea> 
            </div>
          </div>
...
<script src="../vendor/bootstrap/js/bootstr ap.bundle.min.js"></script>
...
<script>
      ...
      var cm1 = new CodeMirror.fromTextArea(document.getElementById("editor"), {
        lineNumbers: true, 
        mode: "javascript", 
        theme: "dracula",
        lineWrapping: false
        ...
        function change_code_screen(lang)
        {
          ...
          xmlhttp.onreadystatechange = function()
          {
            ...
            {
              cm1.setValue(this.responseText);
            }
          }
          xmlhttp.open("GET","code_run/get_content.php?lang="+lang,true);
          xmlhttp.send();    
